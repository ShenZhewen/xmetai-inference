...
supersedes the existing operational version, [1.0 AIFS-single](https://huggingface.co/ecmwf/aifs-single-1.0). 
...
To generate a new forecast using AIFS, you can use [anemoi-inference](https://github.com/ecmwf/anemoi-inference). In the [following notebook](run_AIFS_v1.1.ipynb), a 
...
### AIFS Single v1.1 vs AIFS Single v1.0 (2024)

<div style="display: flex; justify-content: center;">
  <img src="assets/scorecard_single1.1_vs_single1.0_2024.png" alt="Scorecard comparing forecast scores of AIFS versus IFS (2024)" style="width: 80%;"/>
</div>
