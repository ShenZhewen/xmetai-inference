...
#
# 用法：
#   ./run_aifs_minimal.sh                 # 默认 2025010600 / lead 6h
#   TIME=2025010612 LEAD=12 ./run_aifs_minimal.sh
#   bash run_aifs_minimal.sh              # 免 chmod 的方式
#
...
# 切到脚本所在目录，保证 aifs_minimal.py / aifs11.json 能被 import 到
cd "$(dirname "$0")"
